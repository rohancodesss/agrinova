...
- i18n: `MSGS` dict + `msg(key, **kw)`; `settings["lang"]` ∈ en/te/te_en. `/lang` shows a 3-button picker; `/telugu`, `/english` are aliases. Translated: intruder, lockdown, mist, soil line, climate, auto-mist, camera-removed, rain-skip. Everything else stays English.
